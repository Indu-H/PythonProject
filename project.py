                        ...
                        with open(self.patrols_file, "r") as patrol_file:
                            for patrol_line in patrol_file:
                                ...
                                if patrol_data[0] == patrol_id:
                                    total_officers += len(patrol_data[2].split())  # Corrected logic for space-separated officers
                                    break
                    if total_areas == 0:
                        print("No patrols found for the given route.")
                        return
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            officers_assigned = input("Enter Officers Assigned (space-separated): ").split(",")
            ...
            new_officers_assigned = input("Enter new Officers Assigned (space-separated): ").split(",")
